...
<div id="head">
	...
	<div id="hello">
		<label>当前考生:<%=name%></label><br/>
		<label>身份证:<%=IDCard%></label>&nbsp;&nbsp;
	</div>
	<div id="exit">
		<a href="#" data-toggle="modal" data-target="#myModal" onclick="editTest()">修改密码</a>&nbsp;&nbsp;
		<a href="${pageContext.request.contextPath}/jsp/login.jsp" >退出系统</a>
	</div>
</div>
<div id="body">
	<div id="tips">
